        ...
        <div className='card space-between'>
            ...
            <div className='content'>
                ...
                <div className='row space-between m-1'>
                    <a className='redirect top-left-border' target='_blank' href={props.GitLink}><h3>Repository</h3></a>
                    <a className='redirect top-right-border' target='_blank' href={props.WebsiteLink}><h3>Website</h3></a>
                </div>
